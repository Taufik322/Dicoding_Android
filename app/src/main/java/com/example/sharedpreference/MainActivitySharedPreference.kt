...
import com.example.dicodingandroid.databinding.ActivityMainSharedPreferenceBinding

class MainActivitySharedPreference : AppCompatActivity(), View.OnClickListener {

    private lateinit var mUserPreference: UserPreference
    private var isPreferenceEmpty = false
    private lateinit var userModel: UserModel
    private lateinit var binding: ActivityMainSharedPreferenceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainSharedPreferenceBinding.inflate(layoutInflater)
